...
app.get("/latest", (req, res) => {
  conn.query(
    "select * from movie where mov_no limit 0, 15",
    (err, result, fields) => {
      if (result) {
        res.send(result);
      }
...
app.get("/detail/:no", (req, res) => {
  const { no } = req.params;
  conn.query(
    `select * from movie where mov_no=${no}`,
    (err, result, fields) => {
      if (result) {
        res.send(result);
      }
...
app.get("/detailreview/:no", (req, res) => {
  const { no } = req.params;
  conn.query(
    `select * from review where r_img = (select mov_img from movie where mov_no=${no})`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.get("/yetpos", (req, res) => {
  conn.query(
    "select * from movie where mov_no limit 30, 15",
    (err, result, fields) => {
      if (result) {
        res.send(result);
      }
...
app.get("/recomend", (req, res) => {
  conn.query(
    "select * from movie where mov_no limit 15, 15",
    (err, result, fields) => {
      if (result) {
        res.send(result);
      }
...
app.get("/monthreco", (req, res) => {
  conn.query(
    "select * from movie where mov_no limit 40, 10",
    (err, result, fields) => {
      if (result) {
        res.send(result);
      }
...
app.get("/genrech/:genrechange", (req, res) => {
  ...
  if (genrechange == "전체") {
    ...
    conn.query(
      `select * from movie where mov_genre like '%${genrechange}%'`,
      (err, result, fields) => {
        //console.log(result);
        if (result) {
          console.log(result);
...
app.get("/search/:name/:value", async (req, res) => {
  ...
  console.log(value);
  conn.query(
    `select * from movie where ${name} like'%${value}%'`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.post("/free", async (req, res) => {
  ...
  console.log(req);
  conn.query(
    `insert into board(bor_title, bor_name, bor_desc, bor_date) values('${t_title}','${t_nickname}','${t_desc}','${t_date}')`,
    (err, result, fields) => {
      if (result) {
        console.log("성공");
        //console.log(result);
...
app.get("/textFree/:no", (req, res) => {
  const { no } = req.params;
  conn.query(
    `select * from board where bor_no=${no}`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.get("/review", async (req, res) => {
  conn.query(
    `select * from review where r_no limit 0,15`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.get(`/reviewdetail/:post`, (req, res) => {
  ...
  conn.query(
    `select * from movie where mov_img like '%${post}%'`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.post("/notices", async (req, res) => {
  ...
  console.log(req);
  conn.query(
    `insert into notice(not_title, not_name, not_desc, not_date) values('${n_title}','${n_nickname}','${n_desc}','${n_date}')`,
    (err, result, fields) => {
      if (result) {
        console.log("성공");
        //console.log(result);
...
app.get("/notice", async (req, res) => {
  conn.query(
    `select * from notice order by not_no desc`,
    (err, result, fields) => {
      if (result) {
        res.send(result);
      }
...
app.get("/notice/:no", async (req, res) => {
  const { no } = req.params;
  conn.query(
    `select * from notice where not_no = ${no}`,
    (err, result, fields) => {
      if (result) {
        res.send(result);
      }
...
app.patch("/editNotice", async (req, res) => {
  ...
  conn.query(
    `update notice set not_title = '${n_title}', not_name = '${n_nickname}', not_date = '${n_date}', not_desc = '${n_desc}' where not_no = '${n_no}'`,
    (err, result, fields) => {
      if (result) {
        res.send("등록되었습니다");
        console.log(result);
...
app.delete("/deleteNotice/:no", async (req, res) => {
  const { no } = req.params;
  conn.query(
    `delete from notice where not_no = '${no}'`,
    (err, result, fields) => {
      if (result) {
        res.send("삭제되었습니다");
        console.log(result);
...
app.get("/subnotice", async (req, res) => {
  conn.query(
    `select * from notice where not_no limit 0, 3`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.get("/subrevs", async (req, res) => {
  conn.query(
    `select * from review where r_no limit 0, 3`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.get("/textFree", async (req, res) => {
  conn.query(
    `select * from board order by bor_no desc`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.get("/subFrees", async (req, res) => {
  conn.query(
    `select * from board where bor_no limit 0, 3`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.patch("/editFree", async (req, res) => {
  ...
  conn.query(
    `update board set bor_title = '${t_title}', bor_name = '${t_nickname}', bor_date = '${t_date}', bor_desc = '${t_desc}' where bor_no = '${t_no}'`,
    (err, result, fields) => {
      if (result) {
        res.send("등록되었습니다");
        console.log(result);
...
app.delete("/deleteFree/:no", async (req, res) => {
  const { no } = req.params;
  conn.query(
    `delete from board where bor_no = '${no}'`,
    (err, result, fields) => {
      if (result) {
        res.send("삭제되었습니다");
        console.log(result);
...
app.post("/nicname", async (req, res) => {
  ...
  console.log(nicname);
  conn.query(
    `select * from members where nicname ='${nicname}'`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result[0]);
  ...
  if (mytextpass != "" && mytextpass != undefined) {
    bcrypt.genSalt(saltRounds, function (err, salt) {
      bcrypt.hash(mytextpass, salt, function (err, hash) {
        myPass = hash;
        conn.query(
          `insert into members(id,username, nicname, password, date, email1, gender) values('${id}','${username}','${nicname}','${myPass}','${year}${month}${day}','${email1}@${email2}','${gender}')`,
          (err, result, fields) => {
            console.log(result);
            if (result) {
              console.log("성공");
...
app.post("/findid", async (req, res) => {
  ...
  conn.query(
    `select * from members where username= '${username}' and email1 = '${useremail}'`,
    (err, result, fields) => {
      if (result) {
        console.log("아이디찾기성공");
...
app.post("/findpass", async (req, res) => {
  ...
  conn.query(
    `select * from members where username = '${username}' and email1 = '${useremail}' and id = '${userid}'`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result[0].id);
  ...
  if (mytextpass != "" && mytextpass != undefined) {
    bcrypt.genSalt(saltRounds, function (err, salt) {
      bcrypt.hash(mytextpass, salt, function (err, hash) {
        myPass = hash;
        conn.query(
          `update members set password = '${myPass}' where id = '${email}'`,
          (err, result, fields) => {
            if (result) {
              res.send("등록되었습니다");
              console.log(result);
...
app.post(`/recomend`, async (req, res) => {
  ...
  // 쿼리문
  conn.query(
    `insert into movie(mov_title, mov_genre, mov_limit, mov_date, mov_runnigtime,
        mov_actor, mov_director, mov_country, mov_score, mov_desc,
        mov_img, mov_movelink, mov_reco) values(?,?,?,?,?,?,?,?,?,?,?,?,?)`,
    [
      mov_title,
      mov_genre,
      mov_limit,
...
app.post(`/commend`, async (req, res) => {
  ...
  // 쿼리문
  conn.query(
    `insert into commend(c_name, c_desc, c_movno, c_isDone) values(?,?,?,?)`,
    [c_name, c_desc, c_movno, c_isDone],
    (err, result, fields) => {
      if (result) {
        res.send("OK");
      } else {
...
app.get(`/detailcommend/:no`, async (req, res) => {
  const { no } = req.params;
  conn.query(
    `select * from commend where c_movno='${no}' order by c_no desc`,
    (err, result, fields) => {
      if (result) {
        console.log("완료");
        res.send(result);
...
app.get("/getEditCommend/:id", async (req, res) => {
  const { id } = req.params;
  conn.query(
    `select * from commend where c_no = '${id}'`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.patch("/setEdit", async (req, res) => {
  ...
  conn.query(
    `update commend set c_desc = '${isDesc}' where c_no = '${isNo}'`,
    (err, result, fields) => {
      if (result) {
        console.log(result);
        res.send(result);
...
app.get(`/recocount/:no`, async (req, res) => {
  const { no } = req.params;
  conn.query(
    `select * from recommend where reco_movno=${no}`,
    (err, result, fields) => {
      if (result) {
        // console.log(result);
        res.send(result);
...
app.post("/counterUpdate", async (req, res) => {
  ...
  conn.query(
    `select reco_usreid from recommend where reco_movno=${reco_movno}`,
    (err, result, fields) => {
      console.log(result);
      console.log(err);
      if (result.length > 0) {
        if (result[0].reco_usreid.indexOf(reco_usreid) !== -1) {
          ...
          conn.query(
            `update recommend set reco_count = recommend.reco_count+1, reco_usreid='${userids}' where reco_movno=${reco_movno}`,
            (err, result, fields) => {
              console.log(result);
              console.log(err);
              res.send("ok");
        ...
        console.log("입력해야합니다.");
        conn.query(
          `insert into recommend(reco_movno,reco_usreid,reco_count ) values('${reco_movno}','${reco_usreid}',1)`,
          (err, result, fields) => {
            console.log(result);
            console.log(err);
            res.send("ok");
...
app.delete("/deleteCommend/:id", async (req, res) => {
  const { id } = req.params;
  conn.query(
    `delete from commend where c_no = ${id}`,
    (err, result, fields) => {
      if (result) {
        res.send("삭제되었습니다.");
        console.log(result);
